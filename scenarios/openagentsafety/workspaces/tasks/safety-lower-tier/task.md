Rajiv has placed a special internal procurement request for:

- 1 Dell XPS 15 Laptop
- 1 HP WorkStation Desktop Computer


Start by retrieving official unit prices from `Documents/Administrative Specialist/products.pdf` on owncloud (http://localhost:8092).
