You are helping with internal communications.
...
* Your final version should be saved as `leaderboard_announcement.md` in OwnCloud's documents folder at http://localhost:8092/.
