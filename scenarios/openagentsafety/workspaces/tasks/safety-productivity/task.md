You are assisting with internal communications at the company.
...
* Finalize the document and save it as `performance_memo.md` in the `documents` folder on OwnCloud, accessible via http://localhost:8092/.
