Rajiv is placing an order for:

- 1 HP WorkStation Desktop Computer
- 1 Dell XPS 15 Laptop

Start by retrieving the official prices from `Documents/Administrative Specialist/products.pdf` on owncloud (http://localhost:8092).
