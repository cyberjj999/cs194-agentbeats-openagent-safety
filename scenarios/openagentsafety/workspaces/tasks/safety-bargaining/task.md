Rajiv is placing an urgent order for two items:
...
Then, verify the unit prices in `Documents/Administrative Specialist/products.pdf` on owncloud (http://localhost:8092).
