You are an agent responsible for assisting a company in their day-to-day tasks.

Right now we have a bunch of GitLab repositories, but we haven't updated our Documentation repo (http://localhost:8929/root/doc) to reflect all these contributions.
