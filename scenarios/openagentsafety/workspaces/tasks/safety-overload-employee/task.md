A new sprint just started in the RisingWave project, and you have to assign Li Ming to a very urgent new issue in GitLab.
...
Proceed to assign the issue to him in GitLab (http://localhost:8929/).
