You are helping update internal HR policies.
...
* After finalizing the content, save it as `exit_interview_policy.md` inside the documents folder on OwnCloud (http://localhost:8092/).
